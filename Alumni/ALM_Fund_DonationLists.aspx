                                ...
                                <div class="col-md-4">
                                    <div class="evnets-item-shadow">
                                        ...
                                        <div class="course-body">
                                            <asp:HyperLink runat="server" class="readon2 banner-style ext mt-10" NavigateUrl='<%# string.Format("~/Alumni/Alm_Fund_Donation.aspx?ID={0}", HttpUtility.UrlEncode(Eval("encId").ToString())) %>'
