...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <style>
        ...
        .spanLoginReg table tbody tr td span.login-tab-normal.active {
            background: #ff9800;
            color: #fff;
        }

        .spanLoginReg table tbody tr td span.login-tab-normal {
        ...
        /*div#Anthem_ctl00_ContentPlaceHolder1_rdbCategories__ {
                            ...
                            <div class="col-md-4">
                                <div class="evnets-item-shadow">
                                    ...
                                    <div class="course-body">
                                        <asp:HyperLink runat="server" class="readon2 banner-style ext mt-10" NavigateUrl='<%# string.Format("~/Alumni/Alm_FundDonation.aspx?ID={0}", HttpUtility.UrlEncode(Eval("encId").ToString())) %>'
